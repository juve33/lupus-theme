<?php
/**
 * Title: Standard Section (alternative Colors)
 * Slug: lupus/standard-empty-alternative
 * Categories: lupus/standard-sections, lupus/empty-sections, lupus/alternative-colors-sections
 * Description: Standard section with text in alternative colors
 */
?>

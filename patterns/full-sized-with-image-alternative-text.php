<?php
/**
 * Title: Full-sized with Image and Text Background (alternative Colors)
 * Slug: lupus/full-sized-with-image-alternative-text
 * Categories: lupus/full-sized-sections, lupus/alternative-colors-sections, lupus/image-sections, lupus/text-sections
 * Description: Section that covers the whole screen with title, text, image and text in the background in alternative colors
 */
?>

<?php
/**
 * Title: Standard Section with Image and Logo Background (alternative Colors)
 * Slug: lupus/standard-with-image-alternative-logo
 * Categories: lupus/standard-sections, lupus/image-sections, lupus/alternative-colors-sections, lupus/logo-sections
 * Description: Standard section with title, text, image and logo in the background in alternative colors
 */
?>
<!-- wp:group {"tagName":"section","className":"full-width secondary-color-scheme logo-background","layout":{"type":"constrained"}} -->
<section class="wp-block-group full-width secondary-color-scheme logo-background">

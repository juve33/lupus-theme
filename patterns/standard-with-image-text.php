<?php
/**
 * Title: Standard Section with Image and Text Background
 * Slug: lupus/standard-with-image-text
 * Categories: lupus/standard-sections, lupus/image-sections, lupus/standard-colors-sections, lupus/text-sections
 * Description: Standard section with title, text, image and text in the background
 */
?>
<!-- wp:group {"tagName":"section","className":"full-width","layout":{"type":"constrained"}} -->
<section class="wp-block-group full-width">

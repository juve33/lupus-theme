<?php
/**
 * Title: Standard Section with Image (alternative Colors)
 * Slug: lupus/standard-with-image-alternative
 * Categories: lupus/standard-sections, lupus/image-sections, lupus/alternative-colors-sections
 * Description: Standard section with title, text and image in alternative colors
 */
?>

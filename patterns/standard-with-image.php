<?php
/**
 * Title: Standard Section with Image
 * Slug: lupus/standard-with-image
 * Categories: lupus/standard-sections, lupus/image-sections, lupus/standard-colors-sections
 * Description: Standard section with title, text and image
 */
?>

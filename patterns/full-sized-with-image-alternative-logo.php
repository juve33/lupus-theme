<?php
/**
 * Title: Full-sized with Image and Logo Background (alternative Colors)
 * Slug: lupus/full-sized-with-image-alternative-logo
 * Categories: lupus/full-sized-sections, lupus/alternative-colors-sections, lupus/image-sections, lupus/logo-sections
 * Description: Section that covers the whole screen with title, text, image and logo in the background in alternative colors
 */
?>
<!-- wp:group {"tagName":"section","className":"full-sized full-width secondary-color-scheme logo-background","layout":{"type":"constrained"}} -->
<section class="wp-block-group full-sized full-width secondary-color-scheme logo-background">

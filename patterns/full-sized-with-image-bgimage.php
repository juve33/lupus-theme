<?php
/**
 * Title: Full-sized with Image and Background Image
 * Slug: lupus/full-sized-with-image-bgimage
 * Categories: lupus/full-sized-sections, lupus/bgimage-sections, lupus/image-sections
 * Description: Section that covers the whole screen with title, text, image and background image
 */
?>
<!-- wp:group {"tagName":"section","metadata":{"categories":["lupus/full-sized-sections, lupus/image-sections"],"patternName":"lupus/full-sized-with-image-bgimage","name":"Full-sized with Image and Background Image"},"className":"full-sized has-cover","layout":{"type":"constrained"}} -->
<section class="wp-block-group full-sized has-cover">

 ...
 * Slug: lupus/standard-header
 * Categories: header
 * Description: Standard header with title, subtitle and background image
 */
?>
<!-- wp:group {"tagName":"header","className":"has-cover","layout":{"type":"constrained"}} -->
<header class="wp-block-group has-cover">

<?php
/**
 * Title: Full-sized with Image and Logo Background
 * Slug: lupus/full-sized-with-image-logo
 * Categories: lupus/full-sized-sections, lupus/standard-colors-sections, lupus/image-sections, lupus/logo-sections
 * Description: Section that covers the whole screen with title, text, image and logo in the background
 */
?>
<!-- wp:group {"tagName":"section","className":"full-sized full-width logo-background","layout":{"type":"constrained"}} -->
<section class="wp-block-group full-sized full-width logo-background">

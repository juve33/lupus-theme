<?php
/**
 * Title: Full-sized with Image
 * Slug: lupus/full-sized-with-image
 * Categories: lupus/full-sized-sections, lupus/standard-colors-sections, lupus/image-sections
 * Description: Section that covers the whole screen with title, text and image
 */
?>
